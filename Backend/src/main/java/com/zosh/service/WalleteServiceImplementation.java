...
public class WalleteServiceImplementation implements WalletService {
    ...
    public Wallet genrateWallete(Appuser appuser) {
    ...
    @Override
    public Wallet getUserWallet(Appuser appuser) throws WalletException {

        Wallet wallet = walletRepository.findByAppuserId(appuser.getId());
        if (wallet != null) {
            return wallet;
        }

        wallet = genrateWallete(appuser);
        return wallet;
    }
    ...
    public Wallet payOrderPayment(Order order, Appuser appuser) throws WalletException {
        Wallet wallet = getUserWallet(appuser);
